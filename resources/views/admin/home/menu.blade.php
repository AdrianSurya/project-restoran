...
<div class="bg-gray-100 min-h-screen p-6">
  ...
  <div class="flex items-center gap-4 mb-6">
    <button class="bg-red-500 text-white rounded-full px-4 py-1">All</button>
    <button class="bg-white rounded-full px-4 py-1">Foods</button>
    <button class="bg-white rounded-full px-4 py-1">Drinks</button>
  ...
  <div class="flex gap-4">
    ...
    <div class="bg-white rounded-lg shadow w-32 text-center relative">
      ...
      <p class="py-2 font-semibold text-sm">{{ $menu->name }}</p>
      <button class="absolute top-1 right-1 text-red-500">❤</button>
    </div>
    @endforeach
  ...
  <div class="fixed bottom-5 left-0 right-0 flex justify-center">
    <div class="bg-red-500 rounded-full flex items-center px-4 py-2 space-x-6 shadow-lg">
      ...
      <a href="#"><img src="/icons/more.svg" class="w-6"></a>
    </div>
  </div>
</div>
@endsection
